...
public class view_card extends AppCompatActivity {
    ...
    private static class MyOnClickListener implements View.OnClickListener {
        ...
        private void removeItem(View v) {
            ...
            TextView textViewName
                    = (TextView) viewHolder.itemView.findViewById(R.id.category_name);
            String selectedName = (String) textViewName.getText();
            int selectedItemId = -1;
            for (int i = 0; i < MyData.category_names.length; i++) {
                if (selectedName.equals(MyData.category_names[i])) {
    ...
    private void addRemovedItemToList() {
        ...
        data.add(addItemAtListPosition, new DataModel(
                MyData.category_names[removedItems.get(0)],
                MyData.amount_spended[removedItems.get(0)],
